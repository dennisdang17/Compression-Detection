...
int main(int argc, char * argv[])
{
    ...
    *Size_UDP_Payload, *Inter_Measurement_Time, *Number_UDP_Packets, *TTL_UDP_Packets;
    ...
    server_address.sin_addr.s_addr = inet_addr("10.0.0.218"); //hard coded ip
    ...
    if((high_entropy_time - low_entropy_time) > THRESHOLD)
    {
        strcpy(server_message,"COMPRESSION DETECTED\0");;
    }
    else
    {
        strcpy(server_message,"NO COMPRESSION DETECTED\0");
    }
